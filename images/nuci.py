...
df = pd.read_excel("../data/data.xlsx", sheetname="NUCI",
                   index_col=0, skiprows=[0, 1])
df["Ave"] = df.iloc[:, [0]].mean()[0]
df.columns = ["ICU", "Average"]
...
# vix
date_ini = "2001-01-01"
fig_cli = gen_chart(df, "Industrial Capacity Utilization", "Pts", date_ini)
plt.savefig("./NUCI.png")
